...
public class CategoriaDAO {
    ...
    public int create(Categoria cat) throws SQLException {
            ...
            String sql = "INSERT INTO CATEGORIA (NOME, direcao, BANCO, ARCONDICIONADO, VIDRO, TAXAKM, PRECOFIXO) VALUES ('"+cat.getNome()+"','"+cat.getDirecao()+"','"+cat.getBanco()+"','"+cat.getArcondicionado()+"','"+cat.getVidro()+"',"+cat.getTaxakm()+","+cat.getPrecofixo()+")";
    ...
    public void update (Categoria cat) throws SQLException{
            String sql = "UPDATE CATEGORIA SET DIREÇÃO='"+cat.getDirecao()+"', BANCO='"+cat.getBanco()+"',ARCONDICIONADO='"+cat.getArcondicionado()+"',VIDRO='"+cat.getVidro()+",TAXAKM="+cat.getTaxakm()+",PRECOFIXO="+cat.getPrecofixo();
